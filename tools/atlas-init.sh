...
#   docs/<page>.html  x11                       (deck shell: nav + sidebar + stub; incl. Build & Observatory + Test Suite)
...
NAV = [("prd.html","PRD"),("prd-enhanced.html","Enhanced PRD"),("architecture.html","Architecture"),
       ...
       ("observatory.html","Build & Observatory"),("testsuite.html","Test Suite"),
       ("eval.html","Eval"),("cost.html","Cost"),
...
PAGES = {
  ...
  "observatory.html":("Build & Observatory","Live","the build starts — /observe generates the live, project-tailored dashboard"),
  "testsuite.html":("Test Suite","P7 · Test","/test-theater turns the workflow map into the runnable theater + the untouched_functions==0 coverage proof"),
...
if not os.path.exists(regen_path):
    json.dump({
      ...
      "observatory.html":{"kind":"live","note":"live dashboard, generated by /observe — no regen; it streams from .rapid/observe/"},
      "testsuite.html":{"kind":"instant","cmd":"python3 tools/workflow-runner.py --publish-only","note":"the Test Theater, generated by /test-theater; this republishes docs/testruns.json from the recorded runs"}
